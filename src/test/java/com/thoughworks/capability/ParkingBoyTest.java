...
public class ParkingBoyTest {
    ...
    public void should_parking_car_in_only_parking_lot_when_only_one_parking_lot() throws Exception {
        ParkingBoy parkingBoy = new ParkingBoy(Arrays.asList(new ParkingLot("A1", 3)));
    ...
    public void should_parking_car_in_first_parking_lot_when_first_parking_lot_has_enough_spare_position() throws Exception {
        ParkingBoy parkingBoy = new ParkingBoy(Arrays.asList(new ParkingLot("A1", 1), new ParkingLot("A2", 2)));
        var car = new Car("00001");
    ...
    public void should_parking_cars_in_both_parking_lots() throws Exception {
        ParkingBoy parkingBoy = new ParkingBoy(Arrays.asList(new ParkingLot("A1", 2), new ParkingLot("A2", 3)));
    ...
    public void should_throw_exception_when_both_parking_lots_is_full() throws Exception {
        ParkingBoy parkingBoy = new ParkingBoy(Arrays.asList(new ParkingLot("A1", 0), new ParkingLot("A2", 0)));
        var car1 = new Car("00001");
        var car2 = new Car("00002");
        var car3 = new Car("00003");
    ...
    public void should_get_my_car_when_my_car_has_parked_in_parking_lot() throws Exception {
        ParkingBoy parkingBoy = new ParkingBoy(Arrays.asList(new ParkingLot("A1", 3), new ParkingLot("A2", 2)));
        var car1 = new Car("00001");
        var car2 = new Car("00002");
        var car3 = new Car("00003");
    ...
    public void should_throw_exception_when_both_parking_lots_can_not_find_car() throws Exception {
        ParkingBoy parkingBoy = new ParkingBoy(Arrays.asList(new ParkingLot("A1", 3), new ParkingLot("A2", 2)));
        var car1 = new Car("00001");
        var car2 = new Car("00002");
        var car3 = new Car("00003");
    ...
    @Test
    public void should_get_my_cars_when_my_cars_has_parked_in_parking_lot() throws Exception {
        ParkingBoy parkingBoy = new ParkingBoy(Arrays.asList(new ParkingLot("A1", 2), new ParkingLot("A2", 3)));
        var car1 = new Car("00001");
        var car2 = new Car("00002");
        var car3 = new Car("00003");
    ...
    @Test(expected = InvalidTicketException.class)
    public void should_throw_exception_when_both_parking_lots_can_not_find_cars() throws Exception {
        ParkingBoy parkingBoy = new ParkingBoy(Arrays.asList(new ParkingLot("A1", 2), new ParkingLot("A2", 3)));
        var car1 = new Car("00001");
        var car2 = new Car("00002");
        var car3 = new Car("00003");
